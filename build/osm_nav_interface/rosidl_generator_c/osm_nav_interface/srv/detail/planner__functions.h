...
#ifndef OSM_NAV_INTERFACE__SRV__DETAIL__PLANNER__FUNCTIONS_H_
#define OSM_NAV_INTERFACE__SRV__DETAIL__PLANNER__FUNCTIONS_H_
...
#include "osm_nav_interface/msg/rosidl_generator_c__visibility_control.h"

#include "osm_nav_interface/srv/detail/planner__struct.h"

/// Initialize srv/Planner message.
/**
...
/// Create srv/Planner message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * osm_nav_interface__srv__Planner_Request__init().
...
/// Destroy srv/Planner message.
/**
 * It calls
 * osm_nav_interface__srv__Planner_Request__fini()
...
/// Check for srv/Planner message equality.
/**
...
/// Initialize array of srv/Planner messages.
/**
...
/// Finalize array of srv/Planner messages.
/**
 * It calls
 * osm_nav_interface__srv__Planner_Request__fini()
...
/// Create array of srv/Planner messages.
/**
 * It allocates the memory for the array and calls
 * osm_nav_interface__srv__Planner_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Planner messages.
/**
 * It calls
 * osm_nav_interface__srv__Planner_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Planner message array equality.
/**
...
/// Copy an array of srv/Planner messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * osm_nav_interface__srv__Planner_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_osm_nav_interface
...
/**
 * It calls
 * osm_nav_interface__srv__Planner_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_osm_nav_interface
...
/**
 * It allocates the memory for the array and calls
 * osm_nav_interface__srv__Planner_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_osm_nav_interface
...
/**
 * It calls
 * osm_nav_interface__srv__Planner_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // OSM_NAV_INTERFACE__SRV__DETAIL__PLANNER__FUNCTIONS_H_
